...
export interface OrderMeta {
  ...
  salesApprovedTime?: string
  salesConfirmationCc?: Array<{
    department: string
    name: string
    email: string
  }>
...
export function getPhaseFromPath(pathname: string): number {
  ...
  if (pathname.includes("/packing")) return 4
  if (pathname.includes("/delivery")) return 5
  if (pathname.includes("setting-up")) return 5
