...
export function getPhaseFromPath(pathname: string): number {
  ...
  if (pathname.includes("setting-up")) return 3
  if (pathname.includes("dismantle")) return 4
  if (pathname.includes("other-adhoc")) return 5
  if (pathname.includes("completed")) return 6
  return 0
}
