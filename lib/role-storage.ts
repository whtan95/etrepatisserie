...
const MIGRATION_PAGES_BY_ROLE: Partial<Record<UserRole, string[]>> = {
  Manager: ["/portal/quotation/webpage-live", "/portal/quotation/request-for-quotation", "/portal/quotation/official-quotation", "/portal/planning", "/portal/packing", "/portal/delivery", "/portal/returning", "/portal/performance-tracking", "/portal/payment"],
  Sales: ["/portal/quotation/webpage-live", "/portal/quotation/request-for-quotation", "/portal/quotation/official-quotation", "/portal/planning", "/portal/packing", "/portal/delivery", "/portal/returning", "/portal/performance-tracking", "/portal/payment"],
  Warehouse: ["/portal/payment"],
  Traffic: ["/portal/payment"],
  Operation: ["/portal/payment"],
  User: ["/portal/quotation/webpage-live", "/portal/quotation/request-for-quotation", "/portal/quotation/official-quotation", "/portal/planning", "/portal/packing", "/portal/delivery", "/portal/returning", "/portal/performance-tracking", "/portal/payment"],
}
